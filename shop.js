...
class ShopManager {
    ...
    loadProducts() {
        ...
        this.products = [
            ...
            { id: 41, name: 'Sports Nutrition Consultation', category: 'services', price: 100, image: 'images/', description: 'Personalized nutrition plan from a sports dietitian.' },
            { id: 46, name: 'Sports Photography Session', category: 'services', price: 200, image: 'images/', description: 'Professional photos capturing your athletic moments.' },
            { id: 53, name: 'Sports Event Planning', category: 'services', price: 300, image: 'images/', description: 'Professional planning for your sports events.' },

            // Subscriptions & Collectibles (7 items)
            { id: 13, name: 'Monthly Fitness Subscription', category: 'subscriptions', price: 35, image: 'images/', description: 'Access to online fitness classes and personalized plans.' },
            { id: 21, name: 'Autographed Ball', category: 'subscriptions', price: 250, image: 'images/', description: 'Rare collectible: autographed by a legendary athlete.' },
            { id: 28, name: 'Signed Jersey', category: 'subscriptions', price: 400, image: 'images/', description: 'Authentic signed jersey from a sports legend.' },
            { id: 35, name: 'Limited Edition Sports Card', category: 'subscriptions', price: 180, image: 'images/', description: 'Rare limited edition sports trading card.' },
            { id: 47, name: 'Collector\'s Edition Sports Book', category: 'subscriptions', price: 75, image: 'images/', description: 'A must-have for any sports enthusiast\'s library.' },
            { id: 54, name: 'Signed Photo', category: 'subscriptions', price: 100, image: 'images/', description: 'Authentic signed photo of a sports icon.' },
            { id: 61, name: 'Vintage Sports Magazine', category: 'subscriptions', price: 40, image: 'images/', description: 'Rare vintage sports magazine for collectors.' },
