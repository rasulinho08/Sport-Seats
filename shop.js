...
class ShopManager {
    ...
    loadProducts() {
        ...
        this.products = [
            ...
            { id: 1, name: 'Basketball Jersey', category: 'sportswear', price: 50, image: 'images/okey.avif', description: 'Breathable and comfortable jersey for the court.', sizes: ['S', 'M', 'L', 'XL'] },
            ...
            { id: 3, name: 'Football', category: 'equipment', price: 30, image: 'images/aaaaaaa.jpg', description: 'Durable football for training and matches.' },
            { id: 10, name: 'Yoga Mat', category: 'equipment', price: 40, image: 'images/yogamat.jpg', description: 'Non-slip yoga mat for all your poses.' },
            { id: 17, name: 'Resistance Bands Set', category: 'equipment', price: 25, image: 'images/onn.jpg', description: 'Versatile bands for strength training and rehabilitation.' },
            { id: 24, name: 'Dumbbell Set', category: 'equipment', price: 150, image: 'images/asim.jpg', description: 'Adjustable dumbbell set for home workouts.' },
            { id: 31, name: 'Boxing Gloves', category: 'equipment', price: 60, image: 'images/ronaldo.jpg', description: 'High-quality boxing gloves for training and sparring.' },
            { id: 38, name: 'Golf Clubs Set', category: 'equipment', price: 600, image: 'images/siu.jpg', description: 'Complete set of golf clubs for all skill levels.' },
            { id: 43, name: 'Jump Rope', category: 'equipment', price: 10, image: 'images/osman.jpeg', description: 'Adjustable jump rope for cardio and agility training.' },

            // Footwear (7 items)
            { id: 1, name: 'Running Shoes', category: 'footwear', price: 120, image: 'images/sh.avif', description: 'High-performance running shoes for all terrains.', sizes: ['7', '8', '9', '10', '11', '12'] },
            { id: 15, name: 'Soccer Cleats', category: 'footwear', price: 80, image: 'images/alim.jpg', description: 'Lightweight and agile cleats for the soccer field.', sizes: ['7', '8', '9', '10', '11', '12'] },
            { id: 71, name: 'Basketball Sneakers', category: 'footwear', price: 140, image: 'images/abil.jpg', description: 'High-top sneakers for court performance.', sizes: ['7', '8', '9', '10', '11', '12'] },
            { id: 72, name: 'Tennis Shoes', category: 'footwear', price: 90, image: 'images/nat.webp', description: 'Stable and comfortable shoes for tennis.', sizes: ['7', '8', '9', '10', '11', '12'] },
            { id: 73, name: 'Cross Training Shoes', category: 'footwear', price: 110, image: 'images/d.webp', description: 'Versatile shoes for various workouts.', sizes: ['7', '8', '9', '10', '11', '12'] },
            { id: 74, name: 'Hiking Boots', category: 'footwear', price: 160, image: 'images/bo.jpg', description: 'Durable boots for outdoor adventures.', sizes: ['7', '8', '9', '10', '11', '12'] },
            { id: 75, name: 'Cycling Shoes', category: 'footwear', price: 130, image: 'images/save.avif', description: 'Specialized shoes for cycling performance.', sizes: ['7', '8', '9', '10', '11', '12'] },

            // Nutrition & Supplements (7 items)
            { id: 4, name: 'Protein Powder', category: 'nutrition', price: 45, image: 'images/pov.jpg', description: 'High-quality protein for muscle recovery.' },
            { id: 11, name: 'Energy Bars (Box of 12)', category: 'nutrition', price: 28, image: 'images/bar.jpg', description: 'Quick energy boost for your workouts.' },
            { id: 18, name: 'Vitamin Pack', category: 'nutrition', price: 30, image: 'images/raa.png', description: 'Essential vitamins and minerals for overall health.' },
            { id: 25, name: 'Meal Replacement Shakes', category: 'nutrition', price: 55, image: 'images/meal.jpg', description: 'Nutrient-rich shakes for convenient meals.' },
            { id: 32, name: 'Creatine Monohydrate', category: 'nutrition', price: 25, image: 'images/mmm.jpg', description: 'Boost strength and performance with pure creatine.' },
            { id: 39, name: 'Pre-Workout Supplement', category: 'nutrition', price: 35, image: 'images/22.avif', description: 'Boost energy and focus before your workout.' },
            { id: 44, name: 'Post-Workout Recovery Drink', category: 'nutrition', price: 30, image: 'images/drink.jpg', description: 'Aid muscle recovery with this essential drink.' },

            // Tech & Gadgets (7 items)
            { id: 5, name: 'Smartwatch', category: 'tech', price: 200, image: 'images/rond.jpg', description: 'Track your fitness and stay connected.' },
            { id: 12, name: 'Wireless Earbuds', category: 'tech', price: 99, image: 'images/bbk.webp', description: 'High-fidelity sound for your active lifestyle.' },
            { id: 19, name: 'Fitness Tracker', category: 'tech', price: 150, image: 'images/trak.jpg', description: 'Monitor your activity, heart rate, and sleep.' },
            { id: 26, name: 'Action Camera', category: 'tech', price: 300, image: 'images/com.avif', description: 'Capture your adventures in stunning 4K.' },
            { id: 33, name: 'VR Sports Game', category: 'tech', price: 50, image: 'images/disk.jpg', description: 'Immersive virtual reality sports experience.' },
            { id: 40, name: 'Drone with Camera', category: 'tech', price: 450, image: 'images/drone.jpg', description: 'Capture aerial footage of your outdoor activities.' },
            { id: 45, name: 'Portable Bluetooth Speaker', category: 'tech', price: 70, image: 'images/zad.webp', description: 'Enjoy your music anywhere with powerful sound.' },

            // Services (7 items)
            { id: 6, name: 'Personal Training Session', category: 'services', price: 75, image: 'images/zab.webp', description: 'One-on-one session with a certified trainer.' },
            { id: 20, name: 'Sports Massage', category: 'services', price: 90, image: 'images/zub.jpeg', description: 'Relax and recover with a professional sports massage.' },
            { id: 27, name: 'Sports Psychology Coaching', category: 'services', price: 120, image: 'images/z.jpeg', description: 'Improve mental game with expert coaching.' },
            { id: 34, name: 'Sports Injury Rehabilitation', category: 'services', price: 150, image: 'images/za.jpg', description: 'Expert rehabilitation for sports-related injuries.' },
            { id: 41, name: 'Sports Nutrition Consultation', category: 'services', price: 100, image: 'images/img.jpg', description: 'Personalized nutrition plan from a sports dietitian.' },
            { id: 46, name: 'Sports Photography Session', category: 'services', price: 200, image: 'images/dal.jpg', description: 'Professional photos capturing your athletic moments.' },
            { id: 53, name: 'Sports Event Planning', category: 'services', price: 300, image: 'images/sek.jpg', description: 'Professional planning for your sports events.' },

            // Subscriptions & Collectibles (7 items)
            { id: 13, name: 'Monthly Fitness Subscription', category: 'subscriptions', price: 35, image: 'images/35.jpg', description: 'Access to online fitness classes and personalized plans.' },
            { id: 21, name: 'Autographed Ball', category: 'subscriptions', price: 250, image: 'images/top.webp', description: 'Rare collectible: autographed by a legendary athlete.' },
            { id: 28, name: 'Signed Jersey', category: 'subscriptions', price: 400, image: 'images/team.webp', description: 'Authentic signed jersey from a sports legend.' },
            { id: 35, name: 'Limited Edition Sports Card', category: 'subscriptions', price: 180, image: 'images/baku.avif', description: 'Rare limited edition sports trading card.' },
            { id: 47, name: 'Collector\'s Edition Sports Book', category: 'subscriptions', price: 75, image: 'images/jordan.jpg', description: 'A must-have for any sports enthusiast\'s library.' },
            { id: 54, name: 'Signed Photo', category: 'subscriptions', price: 100, image: 'images/pele.jpg', description: 'Authentic signed photo of a sports icon.' },
            { id: 61, name: 'Vintage Sports Magazine', category: 'subscriptions', price: 40, image: 'images/ded.jpg', description: 'Rare vintage sports magazine for collectors.' },

            // Accessories (7 items)
            { id: 8, name: 'Sports Socks (3-pack)', category: 'accessories', price: 15, image: 'image/nas.jpg', description: 'Comfortable and durable sports socks.' },
